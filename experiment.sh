...
do
	...
	python run_neuroreorder.py Datas/$1/Rule/sample$counter --packets=Datas/$1/Packet/sample$counter --experiment_title=$1 --sample_number=$counter --max_steps=$3 --num_env=$4
